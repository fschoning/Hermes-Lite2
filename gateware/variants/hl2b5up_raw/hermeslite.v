...
// Raw front-end release image: hl2b5up_neo (NEORV32 CPU, boot ROM, GDB stub, saved firmware) plus the
// hardware transmit interlock, the front-end I/O register block, real TX samples to the AD9866 DAC under
// the interlock, echo mode and full register access to every radio function. See docs/rawfront/PROTOCOL.md.
module hermeslite (
  // Power
  output       pwr_clk3p3           ,
  output       pwr_clk1p2           ,
  ...
  hermeslite_core #(
    ...
    .RAWSTREAM    (1                                    ),
    .RAWSTREAM_FIFO_AW(13                               ),
    .RAWSTREAM_MAX_N(5968                               ),
    .DUPLEX       (1                                    ),
    .DUPLEX_FIFO_AW(14                                  ),
    .AUX          (1                                    ),
    .AUX_FIFO_AW  (10                                   ),
    ...
    .i2s_miso                  (1'b0                 ),
    .i2s_mosi                  (                     ),
    .io_tp                     ({io_tp9, io_tp8, io_tp7, io_tp2})
  );
