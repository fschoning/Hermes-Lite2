# gowinlink â€” status (branch gowin-link), stopped at "basic test in place"
...
## Verified (Icarus)
- `tb_uart`: PASS â€” UART pair, CRC-8 command framer (good / corrupt / resync), fast serial
...
- Quartus 20.1.1 (Cyclone IV E support now installed): the variant compiles through
  ...
  failed: `Error (176310): Can't place multiple pins assigned to pin location Pin_98` â€”
