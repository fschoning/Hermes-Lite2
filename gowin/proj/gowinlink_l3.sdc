...
create_clock -name fwd_clk -period 6.510 [get_ports {fwd_clk}]

// PLL outputs: VCO 1228.8 MHz; CLKOUT0 /16, CLKOUT1 /8, CLKOUT2 /8 + 90 deg
create_generated_clock -name clk_w -source [get_ports {fwd_clk}] -divide_by 2  [get_pins {top_i/pll_i/pll_i/CLKOUT0}]
create_generated_clock -name clk_l -source [get_ports {fwd_clk}] -multiply_by 1  [get_pins {top_i/pll_i/pll_i/CLKOUT1}]
create_generated_clock -name clk_c -source [get_ports {fwd_clk}] -multiply_by 1 -phase 90 [get_pins {top_i/pll_i/pll_i/CLKOUT2}]
